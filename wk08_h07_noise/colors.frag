...
void main() {
  ...
  // Shaping function that modulate the distance
    ...
    d3 = field(100.,0.5,0.5,st)/1.; 
    
    d4 = field(100.,0.5,0.5,st)/5.3; 
    
    color /=vec3(smoothstep(.2,.4,d3)-smoothstep(.2,.4,d4));
    
    gl_FragColor = vec4(color.r/n, color.g*n, color.b/2.*n, 1.0);
}