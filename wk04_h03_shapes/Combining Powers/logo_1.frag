...
//   color = vec3(smoothstep(.5,.52,max(d-abs(sin(u_time)),d2-abs(cos(u_time)))));
    ...
    float field1 = smoothstep(.5,.52,min(min(d*(1.-(0.2*sin(u_time)))*1.6,d2*(1.-(0.1*sin(u_time)))*1.1), min(d3, d4)))-smoothstep(.5,.52,min(min(d3*(1.-(.1*sin(u_time)))*1.6,d4*(1.-(0.1*sin(u_time)))*1.1), min(d*(1.-(0.1*sin(u_time)))*1.5, d2*.93)));
    
    color = vec3(field1/3., field1/1., field1/(2.*(0.1+abs(sin(u_time))))); 
    
    float field2 = smoothstep(0.3,.32,d3*(1.-(0.1*sin(u_time)))*d2*4.)-smoothstep(0.3,.32,d3*(1.-(0.4*sin(u_time)))*d4*5.);
